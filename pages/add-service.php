...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Verifique se a categoria já existe, se não, insira-a
    ...
    $categoryId = 0;  // Defina um valor padrão
    ...
    $stmt = $conn->prepare("INSERT INTO services (service_name, image_path, price, description, category_name) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("ssdss", $serviceName, $imagePath, $price, $description, $categoryName);
